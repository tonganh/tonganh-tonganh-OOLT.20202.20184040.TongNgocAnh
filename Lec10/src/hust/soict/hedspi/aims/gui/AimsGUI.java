...
//		frame.createButton.addActionListener(new ActionListener() {
//			
//			@Override
...
//			public void actionPerformed(ActionEvent e) {
//				if (anOrder != null) {
//					GUIDialog selectDialog = new GUIDialog(frame,"Select Media");
...
//				}
//				else {
//					JOptionPane.showMessageDialog(null,"Ban chua create Order","Warning",
